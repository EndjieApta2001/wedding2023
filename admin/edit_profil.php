...
//get profil
$sql = "select `nama`, `email`, `foto` from `admin` where `id_admin`='$id_admin'";
 //echo $sql;
...
<?php include("includes/header.php") ?>
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-info">
      ...
      <form class="form-horizontal" method="post" action="konfirmasi_edit_profil.php" enctype="multipart/form-data">
        <div class="card-body">          
