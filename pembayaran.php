            ...
            <div class="card">
                <div class="card-body">
                  <div class="col-sm-10">
                    ...
                    <form id="request" class="main_form" method="post" action="konfirmasi_pembayaran.php">
                     <div class="form-group">
                           <label for="exampleFormControlSelect1">Nama Pembayaran</label>
                                 <select class="form-control" id="nama" name="nama">
                                 <option value="0">- Pilih Nama Pembayaran -</option>
                                 <?php
                    ...
                    <div class="form-group">
                            ...
                            <div>
                              <input type="radio" id="metode_bayar" name="metode_bayar" value="TUNAI"
                                    checked>
                              <label for="huey">TUNAI</label>
                           </div>
                           <div>
                              <input type="radio" id="metode_bayar " name="metode_bayar" value="TRANSFER"
                                    checked>
                              <label for="huey">TRANSFER</label>
                           </div>
                          <button type="submit" class="btn btn-outline-primary">Pembayaran</button>
                      </form>
                </div>
            </div>
         </div>
